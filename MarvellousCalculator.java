...
class MarvellousCalculator
{
    ...
    {
        Calculator cobj = new Calculator(400,400,"Marvellos Calculator");
    }
}
...
class Calculator extends WindowAdapter implements ActionListener
{
    ...
    public Calculator(int width, int hight, String Title)
    {
        ...
        b1.setBounds(10,280,80,40);//x,y,width,hight
        b2.setBounds(100,280,80,40);
        b3.setBounds(185,280,80,40);
        b4.setBounds(270,280,80,40);

        t1.setBounds(85,140,80,40);
